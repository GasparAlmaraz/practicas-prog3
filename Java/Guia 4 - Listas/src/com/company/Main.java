...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Film film1 = new Film(123, 3, Audiencia.G, "Matrix", LocalDate.of(2001, 3, 12), Genero.ACCION);
        Film film2 = new Film(123, 3, Audiencia.G, "Matrix II", LocalDate.of(2002, 3, 21),Genero.AVENTURA);
